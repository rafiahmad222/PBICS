...
class RekamMedisController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'tekanan_darah' => 'nullable|string|max:100',
            'riwayat_penyakit' => 'nullable|string|max:255',
            'keluhan_pasien' => 'nullable|string|max:300',
            ...
            'gambar_sebelum' => 'nullable|image|mimes:jpeg,png,jpg,webp|max:10240',
            'gambar_sesudah' => 'nullable|image|mimes:jpeg,png,jpg,webp|max:10240',
        ...
        try {
            ...
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('RekamMedis Error: ' . $e->getMessage(), ['trace' => $e->getTraceAsString()]);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('RekamMedis Update Error: ' . $e->getMessage(), ['trace' => $e->getTraceAsString()]);
            return response()->json(['message' => 'Terjadi kesalahan', 'error' => $e->getMessage()], 500);
        }
    }
}
